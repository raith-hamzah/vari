...
exports.default = function (n, k) {
  return (0, _mathjs.factorial)(n) / ((0, _mathjs.factorial)(n - k) * (0, _mathjs.factorial)(k));
};
...
var _binomialCoefficient = __webpack_require__(0);
...
exports.default = function (mu, v) {
  ...
  return {
    ...
    cdf: function cdf(x) {
      return 0.5 * (1 + (0, _mathjs.erf)((x - mu) / (sigma * Math.sqrt(2))));
    },
    skewness: skewness,
